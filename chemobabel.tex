...
\begin{figure}[ht]
  \centering
  \chemobabel[width=55mm]{draw/Firefly luciferin.mol}{}
  \chemobabel[width=64mm]{draw/Brevetoxin A.mol}{}
  \caption{Firefly luciferin \& Brevetoxin A (from MDL Molfiles)}
\end{figure}

\begin{figure}[ht]
  \centering
  \chemobabel[width=70mm]{draw/ATP.cdx}{}
  \chemobabel[width=25mm]{draw/Glucose.cdx}{}
  \caption{ATP (Adenosine triphosphate) \& Glucose (from ChemDraw files)}
\end{figure}

\begin{figure}[ht]
  \centering
  \smilesobabel[width=24mm]{CCO}{}
  \smilesobabel[width=30mm]{CC(C(=O)O)N}{}
  \smilesobabel[width=25mm]{C1[C@H](C)C[C@@H](O)C1}{}
...
\begin{figure}[ht]
  ...
  \smilesobabel[width=30mm]{C([C@@H]1[C@H]([C@@H]([C@H]([C@H](O1)O)O)O)O)O}{}
...
\begin{figure}[ht]
  \centering
  \smilesobabel[width=30mm]{CC(=O)Nc1ccc(cc1)O}{}
  \smilesobabel[width=30mm]{CC(=O)Nc1ccc(cc1)O}{-xa}
  \smilesobabel[width=30mm]{CC(=O)Nc1ccc(cc1)O}{-xu}
...
\begin{figure}[ht]
  ...
  \smilesobabel[width=30mm]{C1[C@H](C)C[C@@H](O)C1}{-xC}
  \smilesobabel[width=30mm]{C1[C@H](C)C[C@@H](O)C1}{-xt}
...
\begin{figure}[ht]
  \centering
  \smilesobabel[width=35mm]{CCc1cccc(c1)C(=O)Cl}{}
  \smilesobabel[width=35mm]{CCc1cccc(c1)C(=O)Cl}{-xa -xu}
  \smilesobabel[width=35mm]{CCc1cccc(c1)C(=O)Cl}{-xu -xC}
...
\begin{figure}[ht]
  \centering
  \smilesobabel[width=42mm]{CCc1cccc(c1)C(=O)Cl}{--highlight "cC=O blue"}
...
\begin{figure}[ht]
  \centering
  \chemobabel[width=55mm]{draw/Firefly luciferin.mol}{}
  \chemobabel[width=55mm]{draw/Firefly luciferin.mol}{-xa}
...
\begin{figure}[ht]
  \centering
  \chemobabel[width=56mm]{draw/ATP.cdx}{}
  \chemobabel[width=56mm]{draw/ATP.cdx}{-xd}
...
\begin{figure}[ht]
  \centering
  \smilesobabel[width=35mm]{CN1CC[C@]23c4c5ccc(c4O[C@H]2[C@H](C=C[C@H]3[C@H]1C5)O)O}{}
  \caption{($-$)-Morphine}
...
\begin{figure}[ht]
  \centering
  \smilesobabel[width=96mm]{C[C@@H]1C[C@H]2[C@@H](CC(=O)O2)O[C@H]3C[C@@H]4[C@H](C[C@@H]([C@@H]5[C@@H](O4)C/C=C\C[C@@H]6[C@@H](O5)C/C=C\[C@@H]7[C@@H](O6)CCC[C@@H]8[C@@](O7)(C[C@@H]9[C@@H](O8)C[C@@H]2[C@@H](O9)[C@H](C[C@H](O2)CC(=C)C=O)O)C)C)O[C@@]3(C1)C}{}
